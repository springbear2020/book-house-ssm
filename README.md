...
> 5. 修改邮箱服务器信息（可选，不设置则用户注册时邮箱验证码功能不可用）：修改 `src/main/resources/properties/email.properties` 中的邮箱连接信息，设置你自己的邮箱账号和服务器（个人邮箱开启 smtp 功能指导博客：[smtp 开启](https://blog.csdn.net/smilehappiness/article/details/108145215)）
