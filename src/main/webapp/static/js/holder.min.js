...
!function (a, b) {
    ...
    return function (a) {
        ...
        (function (b) {
            ...
            var v = c(1), w = c(2), x = c(3), y = x.extend, z = x.cssProps, A = x.encodeHtmlEntity,
                B = x.decodeHtmlEntity, C = x.imageExists, D = x.getNodeArray, E = x.dimensionCheck,
                F = "http://www.w3.org/2000/svg", G = 8, H = "2.6.0",
                ...
                J = {
                    ...
                    return function (d) {
                        ...
                        if (K.setup.supportsSVG) {
                            ...
                            var n = b.getComputedTextLength(), r = j.width - n,
                                s = Math.round(r / Math.max(1, l.length - 1)), t = [];
                            if (k > 1) {
                                c.nodeValue = "";
                    ...
                    return function (c) {
                        ...
                        for (var f in e.children) {
                            ...
                            for (var h in g.children) {
                                var i = g.children[h], j = K.dpr(e.x + g.x + i.x),
                    ...
                    if (b.XMLSerializer) {
                        ...
                        return c.appendChild(d), function (b, e) {
                            ...
                            var i = e.holderSettings.flags.holderURL,
                                ...
                                k = o("g", F), l = f.children.holderTextGroup, m = l.properties, n = o("g", F),
                                s = l.textPositionData, t = "#" + j + " text { " + z({
                                    fill: m.fill,
